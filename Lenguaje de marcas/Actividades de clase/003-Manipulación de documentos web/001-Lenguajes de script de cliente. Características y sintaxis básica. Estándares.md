```
'''
Fechas y funciones con retorno en JavaScript
2026 Fabiana Sotillo
Características y sintaxis básica de javascript para el uso de fechas y funciones.
'''
```
...
<script>
  ...
  document.write(diHola("Fabiana", 23));
</script>
```
