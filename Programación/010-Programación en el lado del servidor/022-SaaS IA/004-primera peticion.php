<?php
  ...
  Cuando hagas consultas con Where, usa WHERE x LIKE '%y%'. No me des nada más que código SQL. El código resultante debe ser SQL puro, no markdown. MUY IMPORTANTE: NO quiero fences. 
  ";
  $data = [
  "model" => $MODEL,
  "prompt" => $prompt,
