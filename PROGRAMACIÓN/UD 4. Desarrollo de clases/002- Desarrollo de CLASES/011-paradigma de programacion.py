...
- Listas de instrucciones que se ejecutan una detrás de otra.

Paradigma funcional:
- Creas funciones, las almacenas en memoria y las usas cuando las necesitas
    
Paradigma orientado a objetos:
- No solo creas funciones, si no que creas objetos, los almacenas en memoria, y luego los usas.
    
Cada lenguaje puede adoptar 1 o varios paradigmas
Los lenguajes que adoptan varios programas, se llaman multiparadigma.
...
Oracle se empieza a cargar a Java.
